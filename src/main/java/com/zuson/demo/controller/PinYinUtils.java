...
public class PinYinUtils {
    ...
    public static String getHanziPinYin(String hanzi) {
        ...
        if(null != hanzi && !"".equals(hanzi)) {
            ...
            for (char ch : charArray) {
                ...
                if(null != stringArray) {
                    // 把第几声这个数字给去掉
                    String s = stringArray[0].replaceAll("\\d", "").replaceAll("u:", "v");
                    sb.append(s);
                }
            }
            if(sb.length() > 0) {
    ...
    public static void main(String[] args) {
        System.out.println(PinYinUtils.getHanziInitials("百胜女"));
        System.out.println(PinYinUtils.getHanziPinYin("女路刘"));
        System.out.println(PinYinUtils.getHanziPinYin("刘秋率"));
    }
